...
# Generaly we send an ack back to the device with the tmp_id given be the device and the real id generated by the server
# At this step we also set the real id of the message and deleting the tmp_id
